...
- 참여자들이 서로를 이해하고 협업 분위기를 조성합니다.
- [주요 활동]
  - 자기소개
  - 아이스 브레이킹 게임
![팀 스프레드 - 발표ppt의 사본](https://github.com/user-attachments/assets/b8020af1-4e04-47c1-b5f1-5a66e9065225)

---

### 2. **비전 찾기**
- 프로젝트의 방향성과 목표를 명확히 설정하는 단계입니다.
- 팀의 미션과 비전을 정의합니다.
- [주요 활동]
  - 브레인스토밍
  - 비전 선언문 작성
![팀 스프레드 - 발표ppt의 사본 (1)](https://github.com/user-attachments/assets/4dc58e58-fbe7-40c3-94ee-afbc76764a2e)


---

### 3. **주제 선정**
- 프로젝트의 주제를 자유롭게 논의하고 선정하는 단계입니다.
- 아이디어를 제안하고 공유하며, 우선순위를 결정합니다.
- [주요 활동]
  - 주제 브레인스토밍
  - 투표를 통한 주제 선정
![팀 스프레드 - 발표ppt의 사본 (2)](https://github.com/user-attachments/assets/e6766340-7c54-4e7c-8205-047e4261e385)

---

### 4. **스프레드**
- 제안된 아이디어를 발전시키고 구체화하는 단계입니다.
- 아이디어를 시각화하고 실현 가능성을 평가합니다.
- [주요 활동]
  - 아이디어 시각화
  - 아이디어 간 연관성 분석
![팀 스프레드 - 발표ppt의 사본 (3)](https://github.com/user-attachments/assets/4f615b6d-6c8e-4454-ae41-26470882b4bc)

---

### 5. **토론하기**
- 각 아이디어의 실현 가능성과 구체적인 실행 방안을 논의하는 단계입니다.
- 팀원들의 피드백을 반영하여 최적의 방안을 도출합니다.
- [주요 활동]
  - 실시간 토론
  - 실행 방안 도출
![팀 스프레드 - 발표ppt의 사본 (4)](https://github.com/user-attachments/assets/3b38613a-8652-4df0-93ff-c2043e4d5e3e)

---

### 6. **페르소나**
- 목표 사용자를 정의하고 그들의 요구와 문제를 분석하는 단계입니다.
- 사용자 경험과 요구사항을 구체화합니다.
- [주요 활동]
  - 페르소나 정의
  - 사용자 요구 분석
![팀 스프레드 - 발표ppt의 사본 (5)](https://github.com/user-attachments/assets/e23e8db8-ffcb-4380-a6e0-7918ec8e1b21)

---

### 7. **문제 해결**
- 프로젝트의 주요 문제를 파악하고 해결 방안을 설계하는 단계입니다.
- 구체적인 솔루션을 논의하고 실행 계획을 수립합니다.
- [주요 활동]
  - 문제 정의
  - 해결 방안 도출
![팀 스프레드 - 발표ppt의 사본 (6)](https://github.com/user-attachments/assets/2800d6df-6e04-4e70-a2ec-8bf1d9298a66)

---

### 8. **사용자 스토리**
- 목표 사용자의 관점에서 요구사항과 기대 효과를 정의하는 단계입니다.
- 서비스의 주요 기능과 사용자 경험을 설계합니다.
- [주요 활동]
  - 사용자 시나리오 작성
  - 요구사항 명세
![팀 스프레드 - 발표ppt의 사본 (7)](https://github.com/user-attachments/assets/5002793d-8ff2-43c7-a885-d48a0a92c4c3)

---

### 9. **메뉴 트리**
- 서비스 또는 제품의 구조를 설계하는 단계입니다.
- 각 기능의 상호 연결성과 사용자 흐름을 정의합니다.
- [주요 활동]
  - 메뉴 구조 설계
  - 사용자 흐름도 작성
![팀 스프레드 - 발표ppt의 사본 (8)](https://github.com/user-attachments/assets/1dbec64a-555a-4e38-8318-7abbde2d5dba)

---

### 10. **결과 확인하기**
- 프로젝트 기획 및 설계 과정을 검토하고 완료 여부를 확인하는 단계입니다.
- README.md와 요구사항 명세서를 검토합니다.
- [주요 활동]
  - 최종 보고서 작성
  - 팀 피드백 세션
![팀 스프레드 - 발표ppt의 사본 (9)](https://github.com/user-attachments/assets/5191c4ee-b6bf-49a1-93fe-585a0cd80a30)
